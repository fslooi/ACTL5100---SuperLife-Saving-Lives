...
# Inflation
symbols(3, 2, circles = 1, add = TRUE, inches = 0.2, bg = "#FDA900", lwd=2)
text(3, 2, '2', col = "black", cex = 1)
# Model
...
text(1.2, 4, '6', col = "black", cex = 1)

legend('topright',  legend = c('1: Climate', '2: Inflation', '3: Model', '4: Mortality', '5: Pandemic', '6: War'), cex = 0.8)
